...
from .projects_views import ProjectsCreate, ProjectsDelete, ProjectsDetail, ProjectsList, ProjectsUpdate
from .teams_views import TeamsCreate, TeamsDelete, TeamsDetail, TeamsList, TeamsUpdate